    ...
    getWinner(checkBoard: number[][]): number {
        ...
        for (let y = 0; y < this.rows; y++) {
            for (let x = 0; x < this.collumns; x++) {
                if (
                    this.p(y, x) != 0 &&
                    this.p(y, x) == this.p(y, x + 1) &&
                    this.p(y, x) == this.p(y, x + 2) &&
                    this.p(y, x) == this.p(y, x + 3)
                ) {
                ...
                if (
                    this.p(y, x) != 0 &&
                    this.p(y, x) == this.p(y + 1, x) &&
                    this.p(y, x) == this.p(y + 2, x) &&
                    this.p(y, x) == this.p(y + 3, x)
                ) {
                ...
                for (let d = -1; d <= 1; d += 2) {
                    if (
                        this.p(y, x) != 0 &&
                        this.p(y, x) == this.p(y + 1 * d, x + 1) &&
                        this.p(y, x) == this.p(y + 2 * d, x + 2) &&
                        this.p(y, x) == this.p(y + 3 * d, x + 3)
                    ) {
